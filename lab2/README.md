# Лабораторная работа 2: Сравнение производительности коллекций
...
## Цели работы
1. Сравнить производительность основных типов коллекций .NET: List, LinkedList, Queue, Stack, ImmutableList.
2. Изучить временные характеристики операций добавления, удаления, поиска и доступа по индексу.
3. Проанализировать преимущества и недостатки каждой коллекции в различных сценариях использования.
4. Научиться проводить бенчмарк-тестирование с использованием Stopwatch.
5. Разработать рекомендации по выбору коллекций на основе требований производительности.
